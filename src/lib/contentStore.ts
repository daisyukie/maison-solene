...
const DATA_FILE_PATH = path.join(process.cwd(), 'data', 'siteContent.json')
...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  stats: [
    { number: '04', label: { pt: 'Suítes privativas, nunca compartilhadas', en: 'Private suites, never shared' } },
    { number: "60'", label: { pt: 'Sessão mínima — nenhuma hora corrida', en: 'Minimum session — no rushed hours' } },
    { number: '01', label: { pt: 'Convidado por vez na recepção', en: 'Guest at a time in the reception' } },
  ],
  ...
  homeGallery: [
    { hint: 'detalhe · óleo e linho' },
    { hint: 'suíte em penumbra' },
    { hint: 'corredor · velas' },
  ],
  ...
  houseGallery: [
    { hint: 'foto · lençol e sombra' },
    { hint: 'vídeo · velas e cortina' },
    { hint: 'foto · latão e chama' },
  ],
  ...
  houseRules: [
    { title: { pt: 'Chegada', en: 'Arrival' }, body: { pt: 'Cinco minutos antes — nunca mais cedo. Até ali, a hora ainda é de outra pessoa.', en: 'Five minutes before — never earlier. Until then, the hour still belongs to someone else.' } },
    { title: { pt: 'Silêncio', en: 'Silence' }, body: { pt: 'Celular guardado, nenhuma câmera. A discrição vale para os dois lados da porta.', en: 'Phone away, no camera. Discretion runs on both sides of the door.' } },
    { title: { pt: 'Respeito', en: 'Respect' }, body: { pt: 'O respeito a quem recebe você é a única regra que não se negocia.', en: 'Respect for the person receiving you is the one rule that is never negotiable.' } },
    { title: { pt: 'Sobriedade', en: 'Sobriety' }, body: { pt: 'Sem álcool, sem substância, sem pressa. O corpo precisa estar presente.', en: 'No alcohol, no substances, no hurry. The body needs to be present.' } },
    { title: { pt: 'Cuidado', en: 'Care' }, body: { pt: 'Ducha, linho limpo e roupão prontos — antes e depois, sempre.', en: 'A shower, fresh linen and a robe ready — before and after, always.' } },
  ],
  ...
  faq: [
    ...
    { question: { pt: 'Posso escolher o profissional?', en: 'Can I choose the therapist?' }, answer: { pt: 'Você pode indicar uma preferência no agendamento e atendemos sempre que a agenda permitir.', en: 'You may state a preference when booking and we accommodate it whenever the schedule allows.' } },
    { question: { pt: 'Minha visita é confidencial?', en: 'Is my visit confidential?' }, answer: { pt: 'Totalmente. Guardamos apenas o necessário para manter sua reserva, e nada aparece em extratos além de uma descrição neutra.', en: 'Entirely. We keep only what is needed to hold your booking, and nothing appears on any statement beyond a neutral descriptor.' } },
    { question: { pt: 'Existe estacionamento por perto?', en: 'Is parking available nearby?' }, answer: { pt: 'Sim — há um estacionamento coberto a dois minutos a pé. Os detalhes seguem junto com a confirmação.', en: 'Yes — a covered car park sits two minutes away on foot. Details are sent with your confirmation.' } },
  ],
  ...
  additions: [
    { title: { pt: 'Ritual Noturno', en: 'Evening Ritual' }, value: { pt: '€260', en: '€260' }, body: { pt: '90 minutos após as 21h, com banho quente preparado antes e tempo sem pressa depois.', en: '90 minutes after 21:00, with a warm bath prepared beforehand and unhurried time afterwards.' } },
    { title: { pt: 'Sequência de cinco', en: 'Sequence of five' }, value: { pt: '−15%', en: '−15%' }, body: { pt: 'Cinco sessões da mesma massagem, válidas por seis meses, transferíveis para uma outra pessoa.', en: 'Five sessions of the same massage, valid for six months, transferable to one other person.' } },
    { title: { pt: '30 minutos extras', en: 'Extra 30 minutes' }, value: { pt: '€60', en: '€60' }, body: { pt: 'Somados a qualquer sessão no momento da reserva, conforme a agenda da noite.', en: 'Added to any session at the time of booking, subject to the schedule of the evening.' } },
  ],
